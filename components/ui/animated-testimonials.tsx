        ...
        >
          ...
          <motion.div variants={itemVariants} className="flex flex-col justify-center">
            <div className="space-y-6">
              {badgeText && (
                <div className="inline-flex items-center px-4 py-2 rounded-full text-sm font-medium bg-gradient-to-r from-orange-100 to-rose-100 text-orange-600 border border-orange-200">
          ...
          <motion.div variants={itemVariants} className="relative h-full min-h-[350px] md:min-h-[420px]">
            {testimonials.map((testimonial, index) => (
              ...
              >
                <div className="bg-white border border-slate-200 shadow-xl shadow-slate-200/50 rounded-3xl p-8 h-full flex flex-col">
                  ...
                  <div className="relative mb-6 flex-1">
                    <Quote className="absolute -top-2 -left-2 h-10 w-10 text-orange-200 rotate-180" />
                    <p className="relative z-10 text-lg font-medium leading-relaxed text-slate-700 pl-6">
                      "{testimonial.content}"
                    </p>
                  </div>
            ...
            {/* Decorative elements */}
            <div className="absolute -bottom-6 -left-6 h-24 w-24 rounded-2xl bg-gradient-to-br from-orange-100 to-rose-100"></div>
            <div className="absolute -top-6 -right-6 h-24 w-24 rounded-2xl bg-gradient-to-br from-orange-100 to-rose-100"></div>
          </motion.div>
        </motion.div>
