...
export function HeroSectionOne() {
  return (
    <section className="relative min-h-screen w-full overflow-hidden bg-zinc-50">
      ...
      <div className="absolute left-1/2 top-1/2 h-[400px] w-[400px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-purple-300/20 blur-[100px]" />
      ...
      <div className="relative z-20 mx-auto flex min-h-screen max-w-7xl flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center gap-2 rounded-full border border-orange-200 bg-white/80 px-4 py-2 text-sm font-medium text-orange-600 shadow-sm backdrop-blur-sm">
            ...
            <span>Cyprus&apos;s Premier Event Experience</span>
          </div>
        </motion.div>
        ...
        >
          <ShimmerButton className="min-w-[200px] text-lg shadow-xl shadow-orange-500/20">
        ...
        >
          <div className="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-1 shadow-xl shadow-slate-200/50 transition-all hover:border-orange-200 hover:shadow-2xl hover:shadow-orange-100/50">
            <div className="absolute inset-0 bg-gradient-to-r from-orange-500/5 via-transparent to-rose-500/5 opacity-0 transition-opacity group-hover:opacity-100" />
            <div className="relative flex flex-col gap-6 rounded-xl bg-white p-6 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="flex flex-wrap items-center gap-4 text-sm text-slate-600">
                ...
                <button className="rounded-full bg-gradient-to-r from-orange-500 to-rose-500 px-5 py-2.5 font-semibold text-white shadow-lg shadow-orange-500/30 transition-all hover:shadow-xl hover:shadow-orange-500/40">
                  Get Tickets
                </button>
              </div>
            </div>
