    ...
    <section className="relative min-h-screen w-full overflow-hidden bg-rose-50/30">
      ...
      <div className="relative z-20 mx-auto flex min-h-screen max-w-7xl flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <a href="https://planetarium.memora-experience.com" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-2 rounded-full border-2 border-slate-200 bg-white px-8 py-4 text-lg font-medium text-slate-900 shadow-sm transition-all hover:border-pink-300 hover:shadow-md">
